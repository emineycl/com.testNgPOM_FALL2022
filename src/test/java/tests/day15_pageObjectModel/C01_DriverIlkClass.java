...
public class C01_DriverIlkClass {
    ...
    public void test01() throws InterruptedException {
        ...
        /*
        Driver class'in da ki getDriver() icerisinde driver=new ChromeDriver() satiri her calistiginda
        yeni bir driver olusturur yani yeni bir browser acar.

        Bizim istedigimiz
        bir test calismaya basladiginda driver'a bir kere new ChromeDriver() ile deger atasin
        sonraki calistirmalarda bu satiri pas gecin
         */
