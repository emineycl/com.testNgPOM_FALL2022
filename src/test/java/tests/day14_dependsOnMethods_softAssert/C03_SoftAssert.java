...
public class C03_SoftAssert {
    ...
    public void softAssertTesti(){
        ...
        /*
        jUnit'de de kullandigimiz Assert class'i ilk FAILED olan assertion'da calismayi durdurur ve hata mesaji verir

        Eger ilk hatada durmasini degil, devam edip sona kadar tum testleri yapmasini ve en sonunda durumu raporlayip ,
        failed olan varsa calismayi durdurmasini istiyorsaniz SoftAssert class'ini kullanabilirsiniz

        SoftAssert class'inda ki method'lar static degildir,
        SoftAssert class'inda ki method'lari kullanmak icin obje olusturmaliyiz

        Genellikle
        hardAssertion kullanmamiz istendiginde test edin (Test)
        soft Assertion kullanmamiz istediginde dogrulayin (Verify) kelimeleri kullanilir.
         */

        //A.adim SoftAssert objesi olustur
        SoftAssert softAssert=new SoftAssert();

        //B. istenen tum assertion'larin softAssert objesini kullanarak yapin
        String sifre="JavAahjava";
